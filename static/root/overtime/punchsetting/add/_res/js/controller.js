var app = angular.module('punchsettingAdd', ['toastr','angularjs-dropdown-multiselect']);
app.controller('punchsettingAddCtrl', function($scope, punchsettingSer,$state,toastr,$stateParams,$http){
...
//添加
    $scope.extraAddFun = function(){
        ...
        punchsettingSer.Addpunchset(data).then(function(response){
            if(response.data.code == 0){
