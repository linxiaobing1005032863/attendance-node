var app = angular.module('financesetAdd', ['toastr','angularjs-dropdown-multiselect']);
app.controller('financesetAddCtrl', function($scope, financesetSer,$state,toastr,$stateParams,$http){
...
//添加
    $scope.extraAddFun = function(){
        ...
        financesetSer.Addfinanceset(data).then(function(response){
            if(response.data.code == 0){
