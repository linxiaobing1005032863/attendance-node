var app = angular.module('reviewModule', [{
    files:[
        "root/overtime/review/_res/js/service.js",
    ]
}]);
app.controller('reviewModuleCtrl',function ($scope,$state) {
    ...
    $scope.menuCheck = function (name) {
        ...
        reviewSer.menuPermission(buttonName).then(function(response){
    ...
    $scope.audit = function(){
        if($scope.idListd){
            $state.go('root.overtime.review.audit[12]',{id:$scope.idListd,page:$scope.page});
