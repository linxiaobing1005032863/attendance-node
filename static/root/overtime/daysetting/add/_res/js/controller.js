var app = angular.module('daysetAdd', ['toastr','angularjs-dropdown-multiselect']);
app.controller('daysetAddCtrl', function($scope, daysetSer,$state,toastr,$stateParams,$http){
...
//添加
    $scope.extraAddFun = function(){
        ...
        daysetSer.Adddayset(data).then(function(response){
            if(response.data.code == 0){
